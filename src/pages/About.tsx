...
import { Heart, Award, Users, Utensils, Sparkles, ChefHat } from 'lucide-react';
import { ImageWithFallback } from '../components/ImageWithFallback';
import logo from '../assets/MUST_BE_COW_KBBQ_Sacramento_logo.jpg';

export default function About() {
  useEffect(() => {
    document.title = 'About Us - Must Be Cow | Our Story & Mission';
  }, []);
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <img src={logo} alt="Must Be Cow Logo" className="w-32 h-32 mb-6" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              <h2 className="text-white mb-6">Our History</h2>
              <div className="space-y-4 text-[#d4a574]">
